...
SYSTEM_PROMPT_HINT = (
    ...
    "Use them PROACTIVELY when you need real-time information.\n\n"
    "**CRITICAL RULES:**\n"
    "- web_search returns search results as context for YOU to read.\n"
    "- NEVER dump raw search results to the user.\n"
    "- ALWAYS synthesize a natural, concise answer using the search results.\n"
    "- Cite sources briefly: (source: example.com).\n"
    "- If results are insufficient, call web_fetch to read a specific page.\n"
    "- Keep answers focused on what the user actually asked.\n"
)
...
@register("web_search_auto", "bentianjia", "自动网络搜索（Bing 直连零部署）", "1.3.0")
class WebSearchAuto(Star):
    ...
    async def web_search(
        ...
        lines = [
            f"[Web search results for: {query} — use this to answer, DO NOT dump raw]",
            "",
        ]
